      ...
      <table className="text-sm text-gray-700">
        <thead className="bg-gray-100 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-2 sm:px-3 py-2 text-center min-w-[80px]">First Name</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[80px]">Last Name</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[120px]">Email</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[100px]">Phone</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[80px]">Role</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[80px]">Status</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[60px]">Edit</th>
                <th className="px-2 sm:px-3 py-2 text-center min-w-[60px]">Delete</th>
              </tr>
            </thead>
            ...
            <tbody>
              {loadingUser ? (
                <tr>
                  <td colSpan={9} className="text-center py-4">Loading admins...</td>
                </tr>
              ) : admins.length === 0 ? (
                <tr>
                  ...
                  <tr key={admin._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-2 sm:px-3 py-2 text-center min-w-[60px]">
                      {loadDelUser === admin._id ? (
                        ...
                        <FaTrash onClick={() => deleteUser(admin._id)} className="text-red-500 hover:text-red-300 cursor-pointer" />
                      )}
                    </td>
                  </tr>
                ))
