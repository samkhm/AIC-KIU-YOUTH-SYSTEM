            ...
            <DialogTrigger asChild>
                <Box className="cursor-pointer">
                    <div className="flex items-center justify-between p-1">
                        ...
                        <span
                            className={`bg-gray-200 rounded p-2 italic text-sm ${project.completed ? 'text-green-600' : 'text-red-500'
                                }`}
                        >
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-4">
                                ...
                                >
                                    {loading ? 'Initiating...' : isPolling ? 'Waiting for confirmation...' : 'Pay'}
                                </button>
                        ...
                        <div className='bg-gray-200 rounded border-l-2 border-blue-600 p-4'>
                            <h3 className='w-full flex items-center justify-center border-b border-yellow-400 p-1'>Your contributions for this project</h3>
                            <Mycontributions contributions={contributions} projectId={project._id} />
